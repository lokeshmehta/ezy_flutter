...
class StepPreviewWidget extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 30.h), // Extra space for scrolling above sticky footer
              ],
            ),
          ),
        ),
  ...
  Widget _buildSummaryRow(String label, String value, {bool isBlueValue = false, bool isDiscount = false}) {
    return Padding(
